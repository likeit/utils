...
if (isset($_SESSION['filter']) == 'show_deleted') { $btn_show_del = '<a href="index.php?filter=not_show_deleted">[&nbsp;Не&nbsp;показывать&nbsp;уволенных&nbsp;]</a>'; $filter = ''; }
	else { $btn_show_del = '<a href="index.php?filter=show_deleted">[&nbsp;Показывать&nbsp;уволенных&nbsp;]</a>'; $filter = 'WHERE status!=4 '; };
// -
